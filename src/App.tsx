...
const App = () => {
  ...
  return (
    <div className={isVisible ? "overflow-hidden h-screen" : "h-screen"}>
      {loading ? (
        ...
        >
          <Navbar on={isOn} onClick={handleButtonClick} />
          <MotionComponent
            isVisible={isVisible}
          ...
          <motion.h2
            ...
            className=" text-black text-center font-inter text-xl font-bold  mt-10"
          >
          ...
          <motion.p
            ...
            className="mb-20 mt-4 text-black text-center font-inter text-base font-normal tracking-wide w-4/5 mx-auto"
          >
          ...
          <div className="bg-gray-200 mt-10 py-10 px-3 ">
            <h3 className="text-black text-center font-inter text-xl font-bold tracking-wider">
              EXPERIENCE MORE THAN JUST TRADING
            </h3>

            <p className="text-black text-center font-inter text-base font-normal tracking-wider mt-3 mb-10">
          ...
          <section className="px-2 p-20 text-center ">
            ...
            <p className=" text-sm">
              ...
              Bitcoin: A Peer-to-Peer Electronic Cash System. Bitcoin ushered in
              an entirely new era of cryptocurrencies and has gained popularity
              among individual traders and large investors. Leading trading
              venues such as the CME Group and CBOE Global Markets have already
              introduced trading in Bitcoin futures.
            </p>
          </section>
          ...
          <section className="p-10 ">
            ...
            <div className="text-center border px-4 py-9 text-sm rounded-md mb-7">
              ...
              <Button className="bg-blue-600">Choose Plan</Button>
            </div>
            <div className="text-center border px-4 py-9 text-sm rounded-md mb-7">
              ...
              <ul className="mb-6 leading-8">
                <li>
                  Trading Instruments: 36 currency pairs,CFDs on US stocks,CFDs
                  on indices,CFDs on oil, cryptocurrencies
                </li>
                <li>Spread: Floating from 1.3 pips</li>
                <li>Maximum Leverage: 1:2000</li>
          ...
          <section className="py-10 text-center px-5">
            ...
            <p className="text-lg mb-8">Fast Account Opening in 3 easy steps</p>

            <div className="text-sm mt-4 mb-8">
              <div className="w-20 h-20 mx-auto rounded-full text-white text-3xl py-6 mb-2 bg-blue-300">
                1
              </div>
            ...
            <div className="text-sm mb-8">
              ...
              <p>
                Access over 180 instruments across all asset classes within the
                platform
              </p>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="mb-14">
                ...
                <p className="text-sm font-meium">ORDERS EXECUTED PER SECOND</p>
              </div>
            </div>

            <Button className="bg-blue-600">Set Up Your Trading Account</Button>
          ...
          <section className="mt-20 py-8 px-3 mb-5">
            ...
            <p>
              ...
              personalized customer support around the clock, fast withdrawals,
              and the expertise of industry leaders.
            </p>
          </section>

          <footer className="p-4 bg-blue-400 text-white">
          ...
          <p className="bg-blue-400 text-white text-center text-sm pb-4">
